...
export default function Footer() {
  return (
    <footer className="bg-bark-900 text-cream-100 py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          {/* Col 2 — Contact */}
          <div>
            <h4 className="font-sans text-sm font-semibold uppercase tracking-widest text-cream-100/40 mb-5">
              Contact
            </h4>
            <div className="font-sans text-sm text-cream-100/65 space-y-2.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 hover:text-copper-400 transition-colors"
              >
                <WhatsAppIcon />
                WhatsApp
              </a>
            ...
            <nav className="flex flex-col gap-2.5">
              {NAV_LINKS.map((l) => (
                <Link
                  key={l.href}
                  href={l.href}
                  className="font-sans text-sm text-cream-300 hover:text-copper-400 transition-colors"
                >
                  {l.label}
                </Link>
              ))}
