...
const EQUIPMENT = [
  ...
  },
  {
    ...
    image: '/media/table-reception-soiree-entreprise.webp',
    imageAlt: 'Table ronde nappée et dressée pour un dîner d’entreprise',
  ...
  },
  {
    ...
    imageAlt: 'Chaises installées autour de longues tables dressées sous un barnum',
    imagePosition: 'object-[center_47%]',
  },
  {
    ...
    image: '/media/reception-table-dressee-exterieur.webp',
    imageAlt: 'Assiettes, verres et couverts disposés sur une table de réception',
  ...
  },
  {
    ...
    imageAlt: 'Machine à café professionnelle et tasses installées pour une réception',
    imagePosition: 'object-[center_45%]',
  },
  {
