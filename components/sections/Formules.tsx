...
const formules = [
  {
    ...
    price: '12€',
    unit: '/pers.',
    label: 'La formule essentielle — dès 20 personnes',
    badge: null,
    features: [
      'Four à bois et cuisson sur place',
  ...
  },
  {
    ...
    price: '17€',
    unit: '/pers.',
    label: 'Idéale pour clubs et associations — dès 30 personnes',
    badge: null,
    features: [
      'Crudités en entrée',
  ...
  },
  {
    ...
    price: '24€',
    unit: '/pers.',
    label: 'Salées + sucrées — dès 30 personnes',
    ...
    features: [
      ...
      'Garnitures variées et animation autour du four',
    ],
    highlight: true,
    bg: 'bg-cream-100',
