...
gtag('consent','default',{'ad_storage':granted,'ad_user_data':granted,'ad_personalization':granted,'analytics_storage':granted,'wait_for_update':500});`,
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,s,l,i){if(w.__gtmInjected)return;w.__gtmInjected=true;
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      <body className="bg-cream-50 text-bark-900 font-sans pb-20 md:pb-0">
        ...
        <a
          ...
          className="whatsapp-float hidden md:flex fixed bottom-6 right-6 z-50 items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe5d] hover:shadow-xl transition-all focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
        >
